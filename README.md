...
To run the Socket version, you should start the server first -> src/main/Server.java

The variable qtPlayer tell how many players the match will have, it must be either 2 or 4.

Then you run the amount of clients you configured in the server  -> src/main/Client.java
